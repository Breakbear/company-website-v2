  ...
  return (
    <section className="section-industrial-muted">
      <div className="container-custom grid grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-14">
        <div className="relative overflow-hidden rounded-3xl border border-industrial-700/70">
        ...
        <div>
          ...
          <div className="mt-6 inline-flex rounded-2xl border border-primary-400/40 bg-primary-500/10 px-4 py-3 text-sm text-primary-100">
